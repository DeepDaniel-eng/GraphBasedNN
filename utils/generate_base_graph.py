...
def generate_graph_base_architecture(n_nodes, base_model_node=nn.Linear,base_model_edege=nn.Linear, base_params_node=(1024,1024), base_params_edge=(1024 * 15, 1024 * 3)):
    return {
        node_id: {
...
if __name__ == '__main__':
    ...
    output_size = 10
    graph = generate_graph_base_architecture(5)
